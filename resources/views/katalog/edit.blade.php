                    ...
                    <div class="card-body">
                        <form action="{{ route('katalog.update', $katalog->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">Update Tanggal</label>
                                <input type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ old('tanggal', $katalog->tanggal) }}" placeholder="Masukkan tanggal">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">GAMBAR</label>
                                <input type="file" class="form-control @error('gambar') is-invalid @enderror" name="gambar" value="{{ old('gambar', $katalog->gambar) }}" placeholder="Masukkan gambar">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('harga') is-invalid @enderror" name="harga" value="{{ old('harga', $katalog->harga) }}" placeholder="Masukkan Harga">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" value="{{ old('deskripsi', $katalog->deskripsi) }}" placeholder="Masukkan deskripsi">
                            ...
                            <div class="form-group">
                                <label for="levels">Stok</label>
                                <select type="text" class="form-control" required="required" name="stok" value="{{ old('stok', $katalog->stok) }}">
                                    <option {{ $katalog->stok == 'Ready Stock' ? 'selected' : '' }}>Ready Stock</option>
                                    <option {{ $katalog->stok == 'Pre Order' ? 'selected' : '' }}>Pre Order</option>            
                                </select>
                                <br>
                            </div>
